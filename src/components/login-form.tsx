...
const inputClass = "h-12 w-full rounded-xl border border-[#d8b583] bg-white px-3.5 text-base text-[#44240b] outline-none transition placeholder:text-[#947453] focus:border-[#995c09] focus:ring-3 focus:ring-[#e5950e]/20 aria-invalid:border-red-600 aria-invalid:ring-red-600/15 disabled:opacity-60";
